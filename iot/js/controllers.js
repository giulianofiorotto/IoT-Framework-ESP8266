...
function ModalInstanceCtrl1 ($modalInstance, $modal, $http, $scope, $rootScope) {

    $http.get('public_api.php?task=lightList').success(function(data){
        $scope.lights = data;
        console.log(data);
    })
    .error(function(data,status){
        console.log("errore " + data + " status " + status);
    }); 
    
    
    $scope.select = function (id) { 
        $http.get('public_api.php?task=choseLight&id='+id+'').success(function(data){
            
            $http.get('public_api.php?task=favouriteLight').success(function(data){
                $rootScope.favLight = data;
...
function ModalInstanceCtrl2 ($modalInstance, $modal, $http, $scope, $rootScope) {

    $http.get('public_api.php?task=doorList').success(function(data){
        $scope.doors = data;
        console.log(data);
    })
    .error(function(data,status){
    ...
    $scope.select = function (id) { 
        $http.get('public_api.php?task=chooseDoor&id='+id+'').success(function(data){
            
            $http.get('public_api.php?task=favouriteDoor').success(function(data){
                $rootScope.favDoor = data;
...
function ModalInstanceCtrl3 ($modalInstance, $modal, $http, $scope, $rootScope) {

    $http.get('public_api.php?task=plugList').success(function(data){
        $scope.plugs = data;
        console.log(data);
    })
    .error(function(data,status){
    ...
    $scope.select = function (id) { 
        $http.get('public_api.php?task=choosePlug&id='+id+'').success(function(data){
            
            $http.get('public_api.php?task=favouritePlug').success(function(data){
                $rootScope.favPlug = data;
...
function ModalInstanceCtrl4 ($modalInstance, $modal, $http, $scope, $rootScope) {

    $http.get('public_api.php?task=tempList').success(function(data){
        $scope.temps = data;
        console.log(data);
    })
    .error(function(data,status){
    ...
    $scope.select = function (id) { 
        $http.get('public_api.php?task=chooseTemp&id='+id+'').success(function(data){
            
            $http.get('public_api.php?task=favouriteTemp').success(function(data){
                $rootScope.favTemp = data;
...
angular
    ...
    .controller('dashboardFlotOne', function($scope, $http, $rootScope){
        var data2 = [];
		
		$rootScope.$on('handleBroadcast', function(event, args) {
            $http.get('public_api.php?task=tempChart&id='+args.message[0].id_pin_temperatura+'').success(function(data){
                for (elem in data) {
                    var t = data[elem].date.split(/[- :]/);

                    var d = new Date(t[0], t[1], t[2], t[3], t[4]).getTime();

                    data2.push([d, data[elem].temperatura]);
                }
            })
            .error(function(data,status){
                console.log("errore " + data + " status " + status);
...
/*ar data2 = [
	...
	.controller('detailsCtrl', function($scope, $rootScope, $http) {
		$rootScope.modId = $rootScope.$state.params.moduleId;

        $http.get('public_api.php?task=moduleDetails&id='+$rootScope.modId+'').then(function(result) {
                $scope.IP = result.data[0].IP;
                $scope.name = result.data[0].name;
				$scope.id = result.data[0].id_modulo;
                
                //$http.defaults.useXDomain = true;

                $http.get('public_api.php?task=checkModule&ip='+$scope.IP+'').success(function(data){
                    if(data[0].result == 1){
                        $scope.state = "active";
                    }
                    else{
                        $scope.state = "unactive";
                ...
                console.log("errore " + result + " status " + status);
        });
	...
	.controller('moduleListCtrl', function($scope, $http) {
		$http.get('public_api.php?task=retrieveModule').success(function(data){
	...
	.controller('profileCtrl', function($scope, $rootScope, $http) {
		$http.get('public_api.php?task=selectProfile').success(function(data){
			$scope.user = data[0].name + " " + data[0].surname;
            $scope.name = data[0].name;
            $scope.surname = data[0].surname;
			$scope.imgUser = data[0].image_url;
            $scope.email = data[0].email;
			$rootScope.Name = $scope.name;
			$rootScope.Surname = $scope.surname;

			console.log("profile CTrl   " + data);
		})
		.error(function(data,status){
			console.log("errore " + data + " status " + status);
		}); 
    ...
    .controller('generalLog', function($scope, $http) {
        $http.get('public_api.php?task=generalLog').success(function(data){
            $scope.logs = data;
            console.log(data);
        })
        .error(function(data,status){
    ...
    .controller('moduleLog', function($scope, $rootScope, $http) {
        
        $http.get('public_api.php?task=moduleLog&id='+$rootScope.modId+'').success(function(data){
            $scope.logs = data;
            console.log(data);
        })
        .error(function(data,status){
    ...
    .controller('retrieveLight', function($scope, $rootScope, $http, notify) {
        
        $http.get('public_api.php?task=retrieveLight&id='+$rootScope.modId+'').success(function(data){
            $scope.lightss = data;
            console.log(data);
        })
        .error(function(data,status){
        ...
        $scope.stateTrue = function (state, pin, ip, name, id) {

            $http.get('public_api.php?task=switch&ip='+ip+'&pin='+pin+'').then(function(data){
                console.log(data);
                if(data.data[0].result == '1'){

                    $http.get('public_api.php?task=updateStateLight&id='+id+'&state=0').success(function(data){
                        console.log(data);
                    })
                    .error(function(data,status){
                        console.log("errore " + data + " status " + status);
                    });
                    $scope.lightss[state].stato = 0;

                    $http.get('public_api.php?task=logReg&id=1&testo='+name+'has been turned off').success(function(data){
                        console.log(data);
                    })
                    .error(function(data,status){
                        console.log("errore " + data + " status " + status);
                    ...
                    $scope.inspiniaTemplate = 'views/common/notify.html';
                    notify({ message: 'Error - Offline Module', classes: 'alert-danger', templateUrl: $scope.inspiniaTemplate});

                    console.log("Offline Module");
                }
        ...
        $scope.stateFalse = function (state, pin, ip, name, id) {
            /*$http.get('public_api.php?task=updateStateLight&id='+pin+'&state=1').success(function(data){
                console.log(data);
            })
            .error(function(data,status){
                console.log("errore " + data + " status " + status);
            });
            $scope.lightss[state].stato = 1;*/

            $http.get('public_api.php?task=switch&ip='+ip+'&pin='+pin+'').then(function(data){
                console.log("wadwd"+data);

                if(data.data[0].result == '1'){

                    $http.get('public_api.php?task=updateStateLight&id='+id+'&state=1').success(function(data){
                        console.log(data);
                    })
                    .error(function(data,status){
                        console.log("errore " + data + " status " + status);
                    ...
                    $http.get('public_api.php?task=logReg&id=1&testo='+name+' has been turned on').success(function(data){
                        console.log(data);
                    })
                    .error(function(data,status){
                        console.log("errore " + data + " status " + status);
    ...
    .controller('retrievePlug', function($scope, $rootScope, $http, notify) {

        $http.get('public_api.php?task=retrievePlug&id='+$rootScope.modId+'').success(function(data){
            $scope.plugs = data;
            console.log(data);
        })
        .error(function(data,status){
        ...
        $scope.stateTrue = function (state, pin, ip, name, id) {
/*
            $http.get('public_api.php?task=updateStatePlug&id='+pin+'&state=0').success(function(data){
                console.log(data);
            })
            .error(function(data,status){
                console.log("errore " + data + " status " + status);
            });
            $scope.plugs[state].stato = 0;*/
            ...
            $http.get('public_api.php?task=switch&ip='+ip+'&pin='+pin+'').then(function(data){
                ...
                if(data.data[0].result == '1'){
                    ...
                    $http.get('public_api.php?task=updateStatePlug&id='+id+'&state=0').success(function(data){
                        console.log(data);
                    })
                    .error(function(data,status){
                        console.log("errore " + data + " status " + status);
        ...
        $scope.stateFalse = function (state, pin, ip, name, id) {
            /*$http.get('public_api.php?task=updateStatePlug&id='+pin+'&state=1').success(function(data){
                console.log(data);
            })
            .error(function(data,status){
                console.log("errore " + data + " status " + status);
            });
            $scope.plugs[state].stato = 1;*/

            $http.get('public_api.php?task=switch&ip='+ip+'&pin='+pin+'').then(function(data){

                if(data.data[0].result == '1'){

                    $http.get('public_api.php?task=updateStatePlug&id='+id+'&state=1').success(function(data){
                        console.log(data);
                    })
                    .error(function(data,status){
                        console.log("errore " + data + " status " + status);
    ...
    .controller('retrieveTemp', function($scope, $rootScope, $http) {

        $http.get('public_api.php?task=retrieveTemp&id='+$rootScope.modId+'').success(function(data){
    ...
    .controller('retrieveCustom', function($scope, $rootScope, $http) {

        $http.get('public_api.php?task=retrieveCustom&id='+$rootScope.modId+'').success(function(data){
            $scope.customs = data;
            console.log(data);
        })
        .error(function(data,status){
	...
	.controller('checklight', function($rootScope, $scope, $modal, $http, notify) {
		...
		$scope.open1 = function () {
			var modalInstance = $modal.open({
				templateUrl: 'views/modals/modal_light.html',
				controller: ModalInstanceCtrl1
			});
		};
		
		$scope.stateTrue = function () {
			if($rootScope.favLight[0].stato == 1){

                $http.get('public_api.php?task=switch&ip='+$rootScope.favLight[0].ip
                +'&pin='+$rootScope.favLight[0].pin_hw+'').then(function(data){

                    if(data.data[0].result == '1'){

                        $http.get('public_api.php?task=updateStateLight&id='+$rootScope.favLight[0].id_pin_luce
                        +'&state=0').success(function(data){
                            console.log(data);
                            $rootScope.favLight[0].stato = 0;
                        ...
                        $http.get('public_api.php?task=logReg&id=1&testo='+$rootScope.favLight[0].nome+' has been turned off').success(function(data){
                            console.log(data);
                        })
                        .error(function(data,status){
                            console.log("errore " + data + " status " + status);
		...
		$scope.stateFalse = function () {
			if($rootScope.favLight[0].stato == 0){
                ...
                +'&pin='+$rootScope.favLight[0].pin_hw+'').then(function(data){
                    if(data.data[0].result == '1'){
                        ...
                        $http.get('public_api.php?task=updateStateLight&id='+$rootScope.favLight[0].id_pin_luce
                        +'&state=1').success(function(data){
                            console.log(data);
                            $rootScope.favLight[0].stato = 1;
                        ...
                        $http.get('public_api.php?task=logReg&id=1&testo='+$rootScope.favLight[0].nome+' has been turned on').success(function(data){
                            console.log(data);
                        })
                        .error(function(data,status){
                            console.log("errore " + data + " status " + status);
    ...
    /*DOOR HOME*/
    .controller('checkDoor', function($rootScope, $scope, $modal, $http) {

        $http.get('public_api.php?task=retrieveStateDoor').success(function(data){
            if(data.length == 0){
				...
				$rootScope.flag2 = true;
				if(data[0].armato == 0){
					$rootScope.doorState = false;
				}
				else{
					$rootScope.doorState = true;
        ...
        $scope.open = function () {
            var modalInstance = $modal.open({
                templateUrl: 'views/modals/modal_door.html',
                controller: ModalInstanceCtrl2
            });
        };

        $scope.active = function () {
            $http.get('public_api.php?task=activeWidget').then(function(data){
                if(data.length == 0){
                    $rootScope.flag2 = false;
                    $scope.open();
                }
                else{
					$http.get('public_api.php?task=selectDoor').success(function(data){
					})
					.error(function(data,status){
						console.log("errore " + data + " status " + status);
					});
		...
		$scope.stateTrue = function () {
			if($rootScope.doorState == true){
				$http.get('public_api.php?task=updateStateDoor&state=0&prevState=1').success(function(data){
					console.log(data);
				})
				.error(function(data,status){
					console.log("errore " + data + " status " + status);
                ...
                $http.get('public_api.php?task=notifica&moduleIP=192.168.0.13&token=c9c1d86d02d13&urgenza=MEDIUM&titolo=Allarme&messaggio=Disattivato').success(function(data){
                    
                    console.log("notificaDisattiva");
                })
                .error(function(data,status){
                    console.log("errore " + data + " status " + status);
                });

                $http.get('public_api.php?task=logReg&id=24&testo=Alarm has been turned off').success(function(data){
                    console.log(data);
                })
                .error(function(data,status){
                    console.log("errore " + data + " status " + status);
		...
		$scope.stateFalse = function () {
			if($rootScope.doorState == false){
				$http.get('public_api.php?task=updateStateDoor&state=1&prevState=0').success(function(data){
                ...
                $http.get('public_api.php?task=notifica&moduleIP=192.168.0.13&token=c9c1d86d02d13&urgenza=LOW&titolo=Allarme&messaggio=Attivato').success(function(data){
                    
                    console.log("notificaAttiva");
                })
                .error(function(data,status){
                    console.log("errore " + data + " status " + status);
                });

                $http.get('public_api.php?task=logReg&id=24&testo=Alarm has been turned on').success(function(data){
                    console.log(data);
                })
                .error(function(data,status){
                    console.log("errore " + data + " status " + status);
    ...
    .controller('checkPlug', function($rootScope, $scope, $modal, $http, notify) {
        ...
        $scope.open3 = function () {
            var modalInstance = $modal.open({
                templateUrl: 'views/modals/modal_plug.html',
                controller: ModalInstanceCtrl3
            });
        };   

		$scope.stateTrue = function () {
			if($rootScope.favPlug[0].stato == 1){

				/*$http.get('public_api.php?task=updateStatePlug&id='+$rootScope.favPlug[0].pin
				+'&state=0').success(function(data){
					console.log(data);
				})
				.error(function(data,status){
				...
				$rootScope.favPlug[0].stato = 0;*/


                $http.get('public_api.php?task=switch&ip='+$rootScope.favPlug[0].ip
                +'&pin='+$rootScope.favPlug[0].pin_hw+'').then(function(data){

                    if(data.data[0].result == '1'){

                        $http.get('public_api.php?task=updateStatePlug&id='+$rootScope.favPlug[0].id_pin_presa
                        +'&state=0').success(function(data){
                            console.log(data);
                            $rootScope.favPlug[0].stato = 0;
                        ...
                        $http.get('public_api.php?task=logReg&id=1&testo='+$rootScope.favPlug[0].nome+' has been turned off').success(function(data){
                            console.log(data);
                        })
                        .error(function(data,status){
                            console.log("errore " + data + " status " + status);
		...
		$scope.stateFalse = function () {
			if($rootScope.favPlug[0].stato == 0){
				/*$http.get('public_api.php?task=updateStatePlug&id='+$rootScope.favPlug[0].id_pin_presa
				+'&state=1').success(function(data){
					console.log(data);
				})
                ...
                +'&pin='+$rootScope.favPlug[0].pin_hw+'').then(function(data){
                    ...
                    if(data.data[0].result == '1'){
                        ...
                        $http.get('public_api.php?task=updateStatePlug&id='+$rootScope.favPlug[0].id_pin_presa+'&state=1').success(function(data){
                            console.log(data);
                            $rootScope.favPlug[0].stato = 1;
                        ...
                        $http.get('public_api.php?task=logReg&id=1&testo='+$rootScope.favPlug[0].nome+' has been turned on').success(function(data){
                            console.log(data);
                        })
                        .error(function(data,status){
                            console.log("errore " + data + " status " + status);
    ...
    .controller('checkTemp', function($rootScope, $scope, $modal, $http) {
        ...
        $http.get('public_api.php?task=favouriteTemp').success(function(data){
            if(data.length == 0){
                ...
                $rootScope.favTemp = data;
                $rootScope.flag4 = true;
                $rootScope.$emit('handleEmit', {message: data});
            }
            console.log(data);
        })
        .error(function(data,status){
        ...
        $scope.open4 = function () {
            var modalInstance = $modal.open({
                templateUrl: 'views/modals/modal_temp.html',
                controller: ModalInstanceCtrl4
            });
        };              
        /*
		$scope.stateTrue = function () {
			if($rootScope.favTemp[0].stato == 1){

				$rootScope.favTemp[0].stato = 0;
			}

		};	

		$scope.stateFalse = function () {
			if($rootScope.favTemp[0].stato == 0){
				$rootScope.favTemp[0].stato = 1;
			}
		};	*/
    })
    ...
    .controller('ctrlStatus', function($scope, $rootScope, $http) {

        //$http.defaults.useXDomain = true;

        $http.get('http://2.234.231.234').success(function(data){
        ...
        $http.get('public_api.php?task=ipList').then(function(result) {
            $scope.number = 0;
            angular.forEach(result.data, function(value) {
                $http.get('public_api.php?task=checkModule&ip='+value.ip+'').success(function(data){
                    if(data[0].result == 1){
                        $scope.number += 1;
                    }
    ...
    .controller('profileSetting', function($scope, $rootScope, $http) {
        $http.get('public_api.php?task=selectProfile').success(function(data){
            $scope.name = data[0].name;
            $scope.surname = data[0].surname;
            $scope.imgUser = data[0].image_url;
		...
		$scope.pswChanged = true;
		$scope.wrongPassword = true;
        $scope.field = true;

		
        $scope.changeName = function () {
			$http.get('public_api.php?task=updateName&name='+$scope.usrName+'').success(function(data){
                $rootScope.Name = $scope.usrName; 
			})  
			.error(function(data,status){
				console.log("errore " + data + " status " + status);
			});
        ...
        $scope.changeSurname = function () {
            $http.get('public_api.php?task=updateSurname&surname='+$scope.usrSurname+'').success(function(data){
                $rootScope.Surname = $scope.usrSurname; 
            })  
            .error(function(data,status){
                console.log("errore " + data + " status " + status);
            });
        ...
        $scope.changeEmail = function () {
            $http.get('public_api.php?task=updateEmail&email='+$scope.Email+'').success(function(data){
		...
		$scope.changePassword = function () {
            if($scope.oldPsw != null && $scope.newPsw != null) {
    			$http.get('public_api.php?task=updatePassword&oldPsw='+$scope.oldPsw+'&newPsw='+$scope.newPsw+'').success(function(data){
    				if(data[0].result == '1'){
    					$scope.pswChanged = false;
                        $scope.wrongPassword = true;                  
                        $scope.field = true;                  
    ...
    .controller('settingModule', function($scope, $rootScope, $http) {
        console.log($rootScope);
        $rootScope.modId = $rootScope.$state.params.moduleId;

        $http.get('public_api.php?task=moduleDetails&id='+$rootScope.modId+'').success(function(data){
            $scope.name = data[0].name;
        })
        .error(function(data,status){
            console.log("errore " + data + " status " + status);
        ...
        $http.get('public_api.php?task=retrieveAlarm&id='+$rootScope.modId+'').success(function(data){
            $scope.alarms = data;
            console.log(data);
        })
        .error(function(data,status){
        ...
        $scope.addRow = function() {
            ...
            $scope.rows.push('Pin' + $scope.counter);
            $scope.counter++;
          
        }

        $scope.changeName = function() {
            $http.get('public_api.php?task=changeModuleName&id='+$rootScope.modId+'&name='+$scope.name+'').success(function(data){
            })
            .error(function(data,status){
                console.log("errore " + data + " status " + status);
            });
